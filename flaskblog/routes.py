...
@app.route("/img.png")
def img():
    return redirect(url_for("static", filename="img.png"))
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash("You provided wrong credentials!", "danger")
...
def save_picture(form_picture):
    ...
    _random_hex = secrets.token_hex(8)
    _, f_ext = os.path.splitext(form_picture.filename)
    picture_fn = _random_hex + f_ext
